...
class PersistenciaUsuario {
    ...
    public function insertar($nombre, $cedula, $testimonio, $edad, $dep) {
        $stmt = $this->conn->prepare("
            INSERT INTO testimonios (nombre, documento, testimonio, edad, id_departamento)
            VALUES (?, ?, ?, ?, ?)
        ");
        ...
        $stmt->bind_param("ssssi", $nombre, $cedula, $testimonio, $edad, $dep);
    ...
    public function obtenerTestimonios() {
        $sql = "
            SELECT t.nombre, t.documento, t.testimonio, t.edad, d.nombre AS nombre_departamento
            FROM testimonios t
